...
export default function UpdateProfileForm(props: any): JSX.Element {
    ...
    return (
        <Wrapper >
            <div className='title-form-page ml-[5px] flex flex-row justify-between w-11/12' >
                <div className='font-[700]'>Profile Setup</div>
                <Link to='/profile/settings' style={{color:'#355be4',display:'flex'}} className='text-[16px]' >
